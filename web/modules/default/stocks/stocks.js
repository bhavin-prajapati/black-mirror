...
Module.register("stocks", {
	...
	defaults: {
		...
		fadeSpeed: 1000,
		companies: ["AAPL","AMZN","GOOGL","TWTR","TSLA","INTC","NFLX","MSFT","DIS","XOM","NVDA","MU","QCOM","BABA","VZ",
		"SIRI","SBUX","CVX","JPM","BRK.A","CHK","PFE","CMCSA","BRK.B","WMT","FB","NOK","FCX","ORCL","ATVI","GGB","GE","NKTR","UNH","MCD"],
		currency: "usd",
